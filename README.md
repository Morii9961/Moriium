...
The engineering foundation and three clean-room design studies are implemented. The primary production routes currently use the A structure; public visual identity and design-Skills rules are governed by the canonical [`DESIGN.md`](DESIGN.md), including its explicit open items:
...
- [Design implementation status](docs/design-system.md)
