...
export const api = {
  ...
  /**
   * Operational observations for the panel.
   *
   * Morii decided against alerting, so this screen is the only place a failed
   * backup or a stuck export becomes visible (ADR 0002 section 12.2).
   */
