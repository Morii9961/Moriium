// Editable source nodes for Moriium syntax Tiptap does not model natively.
// The raw Markdown remains ordinary editable text and serializes unchanged.
...
function sourceTextOf(node: JSONContent): string {
