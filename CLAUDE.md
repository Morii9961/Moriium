...
3. [`docs/adr-0001-phase1-spike.md`](docs/adr-0001-phase1-spike.md) — the approved Phase 1 scope, dependencies, and boundaries. Binding for prototype work; section 4 is prototype B's acceptance checklist.
4. [`docs/adr-0002-phase5-production.md`](docs/adr-0002-phase5-production.md) — the production architecture, **draft and not approved**. Do not change anything to match it until Morii approves it; `docs/architecture.md` stays in force.
5. [`docs/enouia-todo.md`](docs/enouia-todo.md) — current work order and decision gates.
6. [`docs/handoff-codex-prototype-b.md`](docs/handoff-codex-prototype-b.md) — the current handoff: how to run prototype B, state, boundaries, verified commands, and the next safe step. Supersedes [`docs/handoff-codex-phase1.md`](docs/handoff-codex-phase1.md), [`docs/handoff-phase1-start.md`](docs/handoff-phase1-start.md), and [`docs/claude-vnext-handoff.md`](docs/claude-vnext-handoff.md), all of which stay as history.
