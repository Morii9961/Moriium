...
9. [`docs/design-system.md`](docs/design-system.md) and [`docs/design-research.md`](docs/design-research.md) — current implementation status and research evidence; neither overrides `DESIGN.md`.
